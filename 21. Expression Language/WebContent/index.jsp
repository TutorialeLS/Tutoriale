...
<h1>Witaj ${param.firstname } ${param.lastname}</h1>
	<jsp:useBean id="user"  class="pl.javastart.model.User" scope="session">
		<jsp:getProperty name="user" property="firstname" value="${param.firstname}" />
	...
	<!-- sposob odwolania sie z EL: 1. ${zasieg.atrybut.parametr} 
									2.	${zasieg.parametr}
									3. ${parametr} - wszystkei zasiegi zostana sprawdzone pod katem parametru
	 -->
