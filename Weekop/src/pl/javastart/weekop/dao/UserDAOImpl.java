...
public class UserDAOImpl implements UserDAO {
	...
	private static final String READ_USER_WITH_ROLE = "SELECT role_name FROM user_role WHERE username=:username";
	...
	@Override
	public String getUserByUserRole(String username) {
		SqlParameterSource paramSource = new MapSqlParameterSource("username",username);
		String userRole=template.queryForObject(READ_USER_WITH_ROLE, paramSource,new RowMapper<String>() {
			@Override
